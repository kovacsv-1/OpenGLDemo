...
static int windowWidth = 1080, windowHeight = 1920;
...
int main(void) {
	...
	glfwSetKeyCallback(window, key_callback); glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED); // ez a sor nincs benne eredetileg
